...
int main(void)
{
    ...
    string className = "This is CS50.";     // 4 or 8 bytes of memory for text (string of characters)
    int age = 30;                           // 4 bytes of memory for an integer
    long long ageOfEarth = 4500000000;      // 8 bytes of memory for an intger
